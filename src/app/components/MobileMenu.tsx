        ...
        <nav className={`fixed w-screen min-h-screen inset-0 bg-default-black z-40 overflow-y-auto overflow-x-hidden duration-slow transition-all ${show && "ml-0"} ${!show && "ml-mobile-menu"}`}>
            ...
            <ul className={`flex flex-col items-center justify-center transition-all mt-10`}>
                ...
                <nav className={`w-full ${showMore && "mb-4"}`}>
                    ...
                    {showMore && (
                        <ul>
                            ...
                            <li className="group border-b-2 border-b-gray-800 text-md font-medium transition-all w-full"><a className="group-hover:text-white flex justify-start px-8 py-4 items-center hover:bg-default-blue w-full active:bg-default-blue cursor-pointer" onClick={() => router.push("/shop")}>TH Shop</a></li>
                ...
                {authenticationContext?.localStorageData.loggedUser && authenticationContext.localStorageData.isLogged && (
                    <>
                        <li className="group text-md font-medium transition-all w-full"><a className="group-hover:text-white flex justify-center py-4 items-center hover:bg-default-blue w-full active:bg-default-blue" onClick={() => router.push("/restrict/management/usersAdmin")}>Área do Administrador</a></li>
