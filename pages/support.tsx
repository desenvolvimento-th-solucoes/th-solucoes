        ...
        <MainLayout typeOfButtonInteraction={1}>
            <div className="pt-[120px] pb-[60px] bg-default-blue">
                ...
                <section className="max-w-7xl mx-auto w-full grid grid-cols-1 xl:grid-cols-3 gap-4 px-4 xl:px-0">
                    ...
                    <Link className="xl:col-start-1 xl:col-end-4 my-4 hover:shadow-xl hover:bg-white/90 bg-white rounded-md text-center py-4 px-4 transition-all text-black flex items-center justify-center gap-4" href="https://thsolucoes.suport.cloud"><ClockArrowUp /> Abrir e Consultar chamados.</Link>
                </section>
            </div>
        </MainLayout>
    )
