    ...
    return (
        <MainLayout typeOfButtonInteraction={1}>
            <div className="pt-[120px] pb-[60px] bg-default-blue">
                ...
                <section className="max-w-7xl mx-auto w-full grid grid-cols-1 xl:grid-cols-3 gap-10 px-4 xl:px-0">
                    <article className="flex flex-col bg-white rounded-md border p-4 w-full h-max">
                        ...
                        <h2 className="text-xl w-[300px] mt-4"><strong>Documentação e instruções</strong> para utilização do TH ERP.</h2>
                    ...
                    <article className="flex flex-col bg-white rounded-md border p-4 w-full h-max">
                        ...
                        <h2 className="text-xl w-[300px] mt-4">Para <strong>sugestões, reclamações ou questões</strong> complexas.</h2>
                    ...
                    <article className="flex flex-col bg-white rounded-md border p-4 w-full h-max">
                        ...
                        <h2 className="text-xl w-[300px] mt-4">Para <strong>tirar dúvidas de utilização</strong> dos sistemas.</h2>
                    ...
                    <Link className="xl:col-start-2 my-4 hover:shadow-xl hover:bg-white/90 bg-white rounded-md text-center py-4 px-4 transition-all text-black flex items-center justify-center gap-4" href="https://thsolucoes.suport.systems/"><ClockArrowUp /> Consultar histórico de chamados.</Link>
                </section>
            </div>
        </MainLayout>
    )
