                    ...
                    <div className="flex flex-col gap-8 min-h-screen py-12 lg:grid lg:grid-cols-2 xl:grid-cols-3">
                        <div className="bg-white text-black rounded-lg h-full w-full p-4 flex items-center justify-center flex-col">
                            ...
                            <div className="grid grid-cols-3 gap-4 w-full">
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-sm md:text-lg">NFPe</div>
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-sm md:text-lg">CTe</div>
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-sm md:text-lg">MDFe</div>
                            </div>
                        </div>
                        <div className="bg-white text-black rounded-lg h-full w-full p-4 flex items-center justify-center flex-col">
                            ...
                            <div className="gap-4 w-full flex items-center justify-center">
                                <div className="w-max px-4 py-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-lg">Livro Caixa</div>
                            </div>
                        </div>
                        ...
                        <div className="h-full w-full p-4 flex items-center justify-center flex-col">
                            ...
                            <div className="flex flex-col gap-4 w-full">
                                <div className="rounded-lg w-full p-4 bg-white text-black flex items-center justify-center text-sm md:text-lg"><div><BiPlusCircle className="text-green-700 text-2xl mr-2" /></div>Desenvolvimento para Pessoa Física (CPF)</div>
                                <div className="rounded-lg w-full p-4 bg-white text-black flex items-center justify-center text-sm md:text-lg"><div><BiPlusCircle className="text-green-700 text-2xl mr-2" /></div>Lucro Real e Presumido</div>
                            </div>
                        </div>
                        <div className="bg-white text-black rounded-lg h-full w-full p-4 flex items-center justify-center flex-col">
                        ...
                        <div className="bg-white text-black rounded-lg h-full w-full p-4 flex items-center justify-center flex-col">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full lg:grid-cols-2">
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-xs text-center md:text-sm lg:text-lg">Recursos</div>
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-xs text-center md:text-sm lg:text-lg">Funcionalidades</div>
                                <div className="w-full lg:col-span-2 p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-xs text-center md:text-sm lg:text-lg">Agilidade</div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4 w-full">
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-xs text-center md:text-sm lg:text-lg">Controle de Produção</div>
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-xs text-center md:text-sm lg:text-lg">Etiquetas</div>
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-xs text-center md:text-sm lg:text-lg">Códigos</div>
                                <div className="w-full p-2 flex items-center justify-center bg-green-200 text-green-400 font-bold rounded-lg text-xs text-center md:text-sm lg:text-lg">Dados Variados</div>
                            </div>
                        </div>
                        <div className="bg-white text-black rounded-lg h-full w-full p-4 flex items-center justify-center flex-col">
                            ...
                            <div className="grid grid-cols-1 gap-4 w-full sm:grid-cols-2">                                
                                <div className="w-full p-2 flex items-center justify-center text-center text-xs bg-green-200 text-green-400 font-bold rounded-lg md:text-md lg:text-lg">Dashboard</div>
                                <div className="w-full p-2 flex items-center justify-center text-center text-xs bg-green-200 text-green-400 font-bold rounded-lg md:text-md lg:text-lg">Gráficos Detalhados</div>
                                <div className="w-full p-2 flex items-center justify-center text-center text-xs bg-green-200 text-green-400 font-bold rounded-lg md:text-md lg:text-lg">Ajuda</div>
                                <div className="w-full p-2 flex items-center justify-center text-center text-xs bg-green-200 text-green-400 font-bold rounded-lg md:text-md lg:text-lg">Relatórios</div>
                            </div>
                        </div>
                        <div className="bg-white col-span-1 text-black rounded-lg h-full w-full p-4 flex items-center justify-center flex-col">
                            ...
                            <div className="w-full">
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    <div className="flex text-center items-center w-full justify-center flex-col rounded-lg p-4 transition-all bg-green-700 text-white">
                            ...
                            <div>
                                ...
                                <div>
                                    <Button.Root hoverTextColor="group-hover:text-white" defaultTextColor={"text-white"} label="Envie uma mensagem" onClick={() => redirect("https://api.whatsapp.com/send/?phone=5519910005366&text&type=phone_number&app_absent=0")}>
                                        <Button.Icon backgroundColor="bg-black" color="text-white" icon={<FaWhatsapp className="absolute left-0 ml-3" />} />
                                    </Button.Root>
                                </div>
                            </div>
                        </div>
